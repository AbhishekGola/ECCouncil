```markdown
# Use Cases of Photon Tool for Passive Recon in Cyber Security

## Introduction

Photon is a powerful and fast crawler designed for automating the process of web scraping and passive reconnaissance. It is widely used in cyber security to gather valuable information about target websites without direct interaction. Photon can help security professionals identify potential vulnerabilities and map the attack surface efficiently.
